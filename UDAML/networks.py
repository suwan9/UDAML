...
class BaseFeatureExtractor1(nn.Module):#基本特征提取程序
    def forward(self, *input):
        pass

    def __init__(self):
        super(BaseFeatureExtractor1, self).__init__()
    def output_num(self):
        pass

resnet_dict = {"resnet18":models.resnet18, "resnet34":models.resnet34, "resnet50":models.resnet50, "resnet101":models.resnet101, "resnet152":models.resnet152}

class ResNetFc(BaseFeatureExtractor1):
...
class AdversarialNetwork1(nn.Module):#对抗网络
    def __init__(self):
        super(AdversarialNetwork1, self).__init__()
        self.main = nn.Sequential()
...
class LargeAdversarialNetwork(AdversarialNetwork1):#大型对抗网络
...
class GradientReverseLayer(torch.autograd.Function): #梯度反向层
    @staticmethod
...
class GradientReverseModule(nn.Module): #梯度反向模块
